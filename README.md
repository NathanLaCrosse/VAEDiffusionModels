...
In each UNet block, we incorporate the following:
  1. Two residual layers that apply a 1x1 convolution, a 3x3 convolution and a final 1x1 convolution. Before the 3x3 convolution, a linearly transformed version of the time embedding is added to theimage. SiLU is used as an activation function and uses groupnorm for normalization.
