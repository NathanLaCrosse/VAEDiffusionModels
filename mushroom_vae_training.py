...
if __name__ == '__main__':
    ...
    u.train_unet(epochs=100, batch_size=1, file_base="unet128.pt", num_time_steps=1000, learning_rate=1e-4, vae_latent_channels=4,
               dropout=0, previous_epochs=0, vae_file=None, latent_width=32, load_file=None, given_vae=vae, num_classes=74)
