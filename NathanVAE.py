...
class Encoder(nn.Module):
    ...
    def __init__(self, latent_channels=4):
        ...
        self.layer1 = NBottleneckBlocks(1,16, 4) # 16 x 64 x 64
        self.down1 = nn.Conv2d(16, 32, 3, 2, 1) # 32 x 32 x 32
        self.layer2 = NBottleneckBlocks(2, 32, 8) # 32 x 32 x 32
        self.down2 = nn.Conv2d(32, 64, 3, 2, 1) # 64 x 16 x 16
        self.layer3 = NBottleneckBlocks(4, 64, 16) # 64 x 16 x 16
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_channels=4):
        ...
        self.layer3 = NBottleneckBlocks(2, 32, 8) # 32 x 32 x 32
        self.up3 = nn.ConvTranspose2d(32, 16, 2, 2) # 16 x 64 x 64
        self.layer4 = NBottleneckBlocks(2, 16, 4) # 16 x 64 x 64
