...
class UNET(nn.Module):
    ...
    def __init__(self, time_embed_dim, label_embed_dim, num_classes, dropout_p=0.0):
        ...
        self.downres1 = nc.NResBlocks(5, 16, 8, 8, time_embed_dim=time_embed_dim, label_embed_dim=label_embed_dim, dropout_p=dropout_p) # 16 x 8 x 8
        
        self.down1 = nn.Conv2d(16, 32, 3, 2, 1) # 16 x 8 x 8 -> 32 x 4 x 4
        self.downres2 = nc.NResBlocks(4, 32, 16, 4, time_embed_dim=time_embed_dim, label_embed_dim=label_embed_dim, dropout_p=dropout_p) # 32 x 4 x 4

        self.down2 = nn.Conv2d(32, 64, 3, 2, 1) # 32 x 4 x 4 -> 64 x 2 x 2
        self.downres3 = nc.NResBlocks(3, 64, 32, 2, time_embed_dim=time_embed_dim, label_embed_dim=label_embed_dim, dropout_p=dropout_p) # 64 x 2 x 2
        ...
        self.upres1 = nc.NResBlocks(4, 32, 16, 4, time_embed_dim=time_embed_dim, label_embed_dim=label_embed_dim, dropout_p=dropout_p)
        ...
        self.upres2 = nc.NResBlocks(5, 16, 8, 8, time_embed_dim=time_embed_dim, label_embed_dim=label_embed_dim, dropout_p=dropout_p)
...
if __name__ == '__main__':
    ...
    train_unet(epochs=100, batch_size=32, file_base="unconditional.pt", num_time_steps=1000, learning_rate=1e-4, dropout=0.0)
